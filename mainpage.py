'''!@file                mainpage.py
    ...
    @section sec_yout   YOUTUBE REFERENCE
                        ...
                        All Videos:                     https://www.youtube.com/playlist?list=PLlT9z-PWNXdNjwoyCqrZTsPmyriopg6Mu
                        
                        

    @section sec_repo   REPOSITORY REFERENCE
                        All code that will be referenced in this portfolio relate to ROMI project
                        is accessible through https://github.com/vvinhvvo98/ROMI-Two-Wheels-Robot
